...
export interface ApiAboutpageAboutpage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    contact: Schema.Attribute.Component<'home.contact', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    footer: Schema.Attribute.Component<'home.foot', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    Teams: Schema.Attribute.Component<'home.team', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    teamsprofessional: Schema.Attribute.Component<
      'home.teams-professionals',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    worksection: Schema.Attribute.Component<'home.work-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCareerPageCareerPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    benefits: Schema.Attribute.Component<'home.benefits', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    Main: Schema.Attribute.Component<'home.career-main', false>;
    position: Schema.Attribute.Component<'home.positions', false>;
    publishedAt: Schema.Attribute.DateTime;
    teammates: Schema.Attribute.Component<'home.team', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Location: Schema.Attribute.Component<'home.location', false>;
    Main: Schema.Attribute.Component<'home.contact-main', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Achievement: Schema.Attribute.Component<'home.achievements', true>;
    community: Schema.Attribute.Component<'home.community', false>;
    contact: Schema.Attribute.Component<'home.contact', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer: Schema.Attribute.Component<'home.foot', false>;
    ...
    > &
      Schema.Attribute.Private;
    Navtabs: Schema.Attribute.Component<'home.navtab', false>;
    publishedAt: Schema.Attribute.DateTime;
    Teams: Schema.Attribute.Component<'home.team-members', false>;
    teamsprofessional: Schema.Attribute.Component<
      'home.teams-professionals',
      false
    >;
...
export interface ApiSignInSignIn extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Signin: Schema.Attribute.Component<'home.signin', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
